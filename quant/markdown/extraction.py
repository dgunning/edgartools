...
from .boundaries import extract_item_with_boundaries
from .constants import ITEM_BOUNDARIES, STATEMENT_TITLES
from .helpers import create_markdown_table, postprocess_text, process_content
from .metadata import extract_filing_metadata
from .types import ExtractedSection

__all__ = ["ExtractedSection", "extract_markdown", "extract_sections"]
        ...
        for stmt_name in _normalize_list(statements):
            ...
            try:
                ...
                sections.append(ExtractedSection(
                    title=STATEMENT_TITLES.get(stmt_name, stmt_name),
                    markdown=markdown,
    ...
    for item_name in _normalize_list(items):
        ...
        try:
            ...
            content = extract_item_with_boundaries(
                html,
                item_name,
                ITEM_BOUNDARIES.get(item_name, ["Item", "Signature"])
            )
            if content:
