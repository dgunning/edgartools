...
def find_company_ticker(cik: Union[int, str]) -> Union[str, List[str]]:
    """
    Find the ticker for a given CIK.

    Parameters:
    cik (int or str): The CIK to look up

    Returns:
    Union[str, List[str]]: A single ticker string if only one ticker is found,
