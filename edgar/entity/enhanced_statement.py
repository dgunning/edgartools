...
class EnhancedStatementBuilder:
    ...
    def _create_deduplicated_revenue_item(self,
        ...
        for period in periods:
            ...
            # it. MetLife tags both the ASC-606 slice and Revenues for the same
            # year, and priority alone reported $2.4B of revenue above $6.1B of
            # operating income (edgartools-fdye). Magnitude stays a cross-check
            # on the ranked pick, never the ranking itself.
        ...
        # to a tag that lost the selection — for MetLife, labelling the
        # consolidated Revenues value as ASC-606 contract revenue.
