...
from edgar.entity.models import FinancialFact, DataQuality, FactCollection
...
class EntityFacts:
    ...
    def income_statement(self, periods: int = 4, period_length: Optional[int] = None, as_dataframe: bool = False, annual: bool = True):
        """
        ...
        result = query.latest_periods(periods, prefer_annual=annual).pivot_by_period(return_statement=not as_dataframe)
    ...
    def balance_sheet(self, periods: int = 4, as_of: Optional[date] = None, as_dataframe: bool = False, annual: bool = True):
        """
    ...
    def cash_flow(self, periods: int = 4, period_length: Optional[int] = None, as_dataframe: bool = False, annual: bool = True):
        """
    ...
    def __repr__(self) -> str:
        ...
        return f"EntityFacts({self.name} [{self.cik}], {len(self._facts):,} facts)"