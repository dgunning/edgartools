...
_FALLBACK_CONCEPT_MAPPINGS = {
    ...
    'LongTermDebtAndCapitalLeaseObligations': 'BalanceSheet',
    'LongTermDebtAndCapitalLeaseObligationsNoncurrent': 'BalanceSheet',
    'LongTermDebtAndCapitalLeaseObligationsCurrent': 'BalanceSheet',
    'LongTermDebtAndCapitalLeaseObligationsIncludingCurrentMaturities': 'BalanceSheet',
    'DebtCurrent': 'BalanceSheet',
    'CurrentPortionOfLongTermDebt': 'BalanceSheet',
    'CurrentPortionOfCurrentContractualObligations': 'BalanceSheet',
    'ShortTermBorrowings': 'BalanceSheet',
    'ShortTermDebt': 'BalanceSheet',
    # Cash Flow
