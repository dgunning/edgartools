...
class ProxyVotes:
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        Returns a DataFrame with one row per vote record, including:
        ...
        - shares_voted: Number of shares voted
        - management_recommendation: Management's recommendation
        - vote_categories: Categories of the vote
        """
        records = []
        for proxy_table in self.proxy_tables:
            base_record = {
                ...
                'vote_categories': ', '.join(vc.category_type for vc in proxy_table.vote_categories),
            }
...
class NPX:
    ...
    def __str__(self) -> str:
        ...
        return f"N-PX{amendment}: {self.fund_name} - {self.period_of_report} ({vote_count} votes)"
    ...
    def __rich__(self):
        ...
        title.append(f" - {self.fund_name}", style="bold")
