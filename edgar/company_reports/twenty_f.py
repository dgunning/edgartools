...
class TwentyF(CompanyReport):
    ...
    def to_context(self, detail: str = 'standard') -> str:
        ...
        # === IDENTITY ===
        lines.append(f"TWENTYF: {self.company} Foreign Issuer Annual Report")
        lines.append("")
        ...
        lines.append("  .key_information         Item 3 key information")
        lines.append("  .risk_factors            Item 3 risk factors")
        lines.append("  .business                Item 4 business overview")
        lines.append("  .management_discussion   Item 5 operating review")
