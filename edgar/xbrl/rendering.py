...
def render_statement(
    ...
    for _index, item in enumerate(statement_data):
        ...
        # GH-0609: skip non-dimensional rows that already carry a periodStart/periodEnd
        # label from XBRL -- their label is already "...beginning/ending balances",
        ...
        for period in formatted_period_objects:
            ...
            # GH-0609: General roll-forward mapping for periodStart/periodEnd
