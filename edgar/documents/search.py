...
from edgar.documents.nodes import HeadingNode, Node
...
class DocumentSearch:
    ...
    def _get_ranking_engine(self, algorithm: str, nodes: List[Node],
        ...
        from edgar.documents.ranking.cache import CacheEntry, get_search_cache
        from edgar.documents.ranking.ranking import BM25Engine, HybridEngine, SemanticEngine
