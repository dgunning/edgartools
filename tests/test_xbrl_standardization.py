...
def test_companies():
    ...
    result = {}
    aapl_xbrl = XBRL.from_directory("tests/fixtures/xbrl/aapl/10k_2023")
    result['aapl'] = aapl_xbrl
    
    nflx_xbrl = XBRL.from_directory("tests/fixtures/xbrl/nflx/10k_2024")
...
def test_dimensional_data():
    ...
    return XBRL.from_directory("tests/fixtures/xbrl/ko/10k_2024")
