                                ...
                                <tbody>
                                    <tr>
                                        <td nowrap="0">
                                         ...
                                         <td nowrap="0">
											<xsl:choose>   
												<xsl:when test="$XML/n1:edgarSubmission/n1:formData/n1:coverPage/n1:crdNumber != &quot;&quot;">
													 <xsl:for-each select="$XML">
														<xsl:for-each select="n1:edgarSubmission">
															<xsl:for-each select="n1:formData">
																<xsl:for-each select="n1:coverPage">
                                ...
                                <tbody>
                                    <tr>
                                        <td nowrap="0">
                                         ...
                                         <td nowrap="0">
											<xsl:choose>   
												<xsl:when test="$XML/n1:edgarSubmission/n1:formData/n1:coverPage/n1:secFileNumber != &quot;&quot;">
													 <xsl:for-each select="$XML">
														<xsl:for-each select="n1:edgarSubmission">
															<xsl:for-each select="n1:formData">
																<xsl:for-each select="n1:coverPage">
